...
//            new Twig_SimpleFunction('assetic_js', [$this, 'asseticJs']),
    ...
    public function jsTag($name)
    {
        ...
        if (':jquery' == $name) {
            $name = '//ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js';
        }
    ...
    #todo cache?
    protected function setTimeStamp(&$path)
    {
        $fullpath = app('path.public').$path;
